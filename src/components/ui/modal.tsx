  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed left-1/2 top-1/2 max-h-72 w-80 -translate-x-1/2 -translate-y-1/2 rounded-md bg-slate-100 ring-1 ring-slate-200 p-5 shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none font-sans'>
